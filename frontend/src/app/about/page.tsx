...
const teamMembers: TeamMember[] = [
  {
    ...
    contributions: [
      ...
      <span><strong className="text-cyan-400 font-bold">AI Safety & Training:</strong> Pen-tested the Sentra AI model using prompt injection attacks and hardened it with stronger, more secure prompt defenses.</span>,
